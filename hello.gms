...
SETS
    ...
    O(i)    groups with single bond !! define relation with H  /i1/
;
...
eq2a..     p('j5') =e= (sum(i,n(i)*c(i,'5'))-19.7779)+(sum(i,n(i)*c(i,'6'))+22.5981)*theta+(sum(i,n(i)*c(i,'7'))-10.7983)*theta**2;
eq2b..     theta =e= (Tm-298)/700;
eq3a..     p('j6') =e= exp(f0('1')+p('j11')*f1('1')+p('j11')**2*f2('1'))*p('j3');
eq3b..     p('j7') =e= exp(f0('2')+p('j11')*f1('2')+p('j11')**2*f2('2'))*p('j3');
